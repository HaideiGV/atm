...
(function(a){a.jqx.jqxWidget("jqxMaskedInput","",{});
...
a.extend(true,this,b);return b},

createInstance:function(b){this.render()},
render:function(){
    var e=this;
    e.host.attr({role:"textbox"});
    e.host.attr("data-role","input");
    var f=e.host.attr("value");
    if(f!=undefined&&f!=""){e.value=f}a.jqx.aria(this);
    ...
    if(e.element.nodeName.toLowerCase()=="div"){
        ...
        e.maskbox.attr("spellcheck",false)}e.maskbox.addClass(e.toThemeProperty("jqx-reset"));
        ...
        e.propertyChangeMap.disabled=function(g,j,h,k){
            ...
            if(e.disabled){e.maskbox.addClass(
                ...
                e.host.addClass(e.toThemeProperty("jqx-fill-state-disabled"))}e.selectedText="";
                e.self=this;
                e.oldValue=e._value();
                e.items=new Array();
                                ...
                                if(g=="$"){
                                    ...
                                    if(g=="/"||g==":"){
                                        ...
                                        if(g=="A"||g=="a"){
                                            h="\\w";
                                            b=true
                                        }else{if(g=="c"||g=="C"){h=".";b=true}else{if(g=="L"||g=="l"){h="([a-zA-Z])";b=true}}}}}}
                        }
